...
class GDSAPI:
    reserved_fields = ['api', 'driver', 'context', 'generate_callable_neo4j_function', 'generate_cypher']
    ...
    def generate_cypher(self, api, args):
        cypher = """
            WITH 'This query generated by magiclib v0.01' AS disclaimer
            CALL %s(
        """ % (api['name'])
    ...
    def generate_callable_neo4j_function(self, context, api):
        ...
        def closure(*args):
            ...
            with self.driver.session() as session:
                ...
                logging.debug("RUNNING CYPHER %s" % cypher)
                print(cypher)
                print(params)
                return []
